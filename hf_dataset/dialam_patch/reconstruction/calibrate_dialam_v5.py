...
DEFAULT_REPORT = PROJECT_ROOT / "reports" / "dialam_v5_1_calibration.json"
DATA_MANIFEST = (
    PROJECT_ROOT / "data" / "dialam" / "training" / "training_v5_manifest.json"
)
PREREGISTRATION = (
    PROJECT_ROOT / "docs" / "dialam_v5_1_calibration_preregistration.md"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Select the preregistered v5.1 NONE margin on development data"
    )
    ...
    report = {
        "schema_version": "dialam_v5_1_none_margin_calibration_v1",
        "experiment": "v5.1 fixed-grid development NONE-margin calibration",
        "preregistered_before_tuned_v5_development_predictions": True,
        ...
        "development_decision": (
            ...
            else "RETAIN_V3_V5_1_FAILED_DEVELOPMENT_GATE"
        ),
        "frozen_status": (
