...
from flowjudge.dialam_training import DEFAULT_TRAINING_DIR, build_dialam_training_corpus
from flowjudge.patch_data import DEFAULT_EVAL_SUMMARY_PATH


def main() -> None:
    parser = argparse.ArgumentParser(description="Build nested private DialAM QLoRA slices")
    ...
    manifest = build_dialam_training_corpus(
