...
OUTPUT = PROJECT_ROOT / "reports" / "dialam_v8_resume_smoke.json"
DOC = PROJECT_ROOT / "docs" / "dialam_v8_resume_smoke.md"
...
def build_report() -> dict[str, Any]:
    ...
    checks = {
        "nested_smoke_size_is_252": training["size"] == data["smoke_size"] == 252,
    ...
    report = {
        "schema_version": "dialam_v8_resume_smoke_result_v1",
        "experiment": "v8/n252 intentional interruption and exact-state resume",
        "decision": "PASS" if all(checks.values()) else "FAIL",
        "all_checks_passed": all(checks.values()),
        "checks": checks,
        "intentional_interruption": {
            "modal_app_id": "ap-ahmeHXFYTgU0eoOGQAHuth",
            "expected_error": (
        ...
        "resume_completion": {
            "modal_app_id": "ap-NJHZsGTtGeaJe7FNErxN6B",
        ...
        "idempotent_reuse": {
            "modal_app_id": "ap-wKjPfbTK1lSWgDPsNIXuA2",
        ...
        "private_local_artifacts": {
            ...
            "modal_checkpoint_root": (
                "/workspace/persistent/checkpoints/v8_resume_smoke_n252"
            ),
        },
