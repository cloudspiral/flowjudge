...
from flowjudge.dialam_training_v9 import build_v9_mining_inputs
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build private QT30 training-only V9 hard-negative mining inputs"
    )
    ...
    manifest = build_v9_mining_inputs(
