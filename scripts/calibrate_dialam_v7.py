...
DEFAULT_REPORT = PROJECT_ROOT / "reports" / "dialam_v7_calibration.json"
DATA_MANIFEST = (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Select the preregistered v7.1 NONE margin on development data"
    )
    ...
    report = {
        "schema_version": "dialam_v7_1_none_margin_calibration_v1",
        "experiment": "v7.1 fixed-grid development NONE-margin calibration",
        "preregistered_before_v7_training": True,
        ...
        "development_decision": (
            ...
            else "RETAIN_V5_1_V7_FAILED_DEVELOPMENT_GATE"
        ),
        "frozen_status": (
