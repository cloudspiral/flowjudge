...
DEFAULT_REPORT = PROJECT_ROOT / "reports" / "dialam_v8_calibration.json"
DATA_MANIFEST = (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run the preregistered v8 transition-complete NONE-margin scan "
    ...
    if not resume_smoke["all_checks_passed"]:
        raise ValueError("v8 development calibration is blocked by resume smoke failure")
    ...
    report = {
        "schema_version": "dialam_v8_1_transition_complete_calibration_v1",
        "experiment": "v8.1 transition-complete development NONE-margin calibration",
        "preregistered_before_v8_corpus_and_training": True,
        "lower_bound": LOWER_BOUND,
        ...
        "development_decision": (
            ...
            if passed
            else "RETAIN_V5_1_V8_FAILED_DEVELOPMENT_GATE"
        ),
        "frozen_status": (
